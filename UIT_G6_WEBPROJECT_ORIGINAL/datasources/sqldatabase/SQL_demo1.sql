...
VALUES (1, 1, 'Giữa cơn bão tuyết', '221112', 1, NOW(), NOW()),
(1, 1, 'Nữ luật sư kỳ lạ', '197067', 2, NOW(), NOW()),
(1, 1, 'Lấy danh nghĩa người nhà', '107329', 3, NOW(), NOW()),
(1, 1, 'Hoàn hồn ALCHEMY OF SOULS', '135157', 4, NOW(), NOW()),
(1, 1, 'Đời sống ngục tù', '74821', 5, NOW(), NOW()),
(1, 1, 'Mùa hè yêu dấu của chúng ta', '135897', 6, NOW(), NOW()),
(1, 1, 'Yêu tinh', '67915', 7, NOW(), NOW()),
(1, 1, 'Vinh quang trong thù hận', '136283', 8, NOW(), NOW()),
(1, 1, 'Khi anh chạy về phía em', '228547', 9, NOW(), NOW()),
(1, 1, 'Trường tương tư', '210524', 10, NOW(), NOW()),
(1, 1, 'Trường tương tư', '210524', 11, NOW(), NOW()),
(1, 1, 'Đi đến nơi có gió', '216424', 12, NOW(), NOW()),
(1, 1, 'Chiếc bật lửa và váy công chúa', '134331', 13, NOW(), NOW()),
(1, 1, 'Minh lan truyện', '81502', 14, NOW(), NOW()),
(1, 1, 'Chệch quỹ đạo', '237918', 15, NOW(), NOW()),
(1, 1, 'Trường nguyệt tẫn minh', '137206', 16, NOW(), NOW()),
(1, 1, 'Em đẹp nhất là khi mỉm cười', '95486', 17, NOW(), NOW()),
(1, 1, 'Yêu em từ cái nhìn đầu tiên', '66776', 18, NOW(), NOW()),
(1, 1, 'An lạc truyện', '134679', 19, NOW(), NOW()),
(1, 1, 'Thương lan quyết', '130368', 20, NOW(), NOW()),
(1, 1, 'Trường ca hành', '122182', 21, NOW(), NOW()),
(1, 1, 'Go go squid', '82817', 22, NOW(), NOW()),
(1, 1, 'Manh thê thực thần', '79574', 23, NOW(), NOW()),
(1, 1, 'Put your head on my shoulder', '88548', 24, NOW(), NOW()),
(1, 1, 'Tôi đã gặp được vị cứu tinh', '216405', 25, NOW(), NOW()),
(1, 1, 'Tình đầu ngây ngô', '95100', 26, NOW(), NOW()),
(1, 1, 'Thả thí thiên hạ', '127323', 27, NOW(), NOW()),
(1, 1, 'Cuộc sống lý trí', '122206', 28, NOW(), NOW()),
(1, 1, 'Lưỡng bất nghi', '121870', 29, NOW(), NOW()),
(1, 1, 'Tại sao boss muốn cưới tôi?', '86605', 30, NOW(), NOW()),
(1, 1, 'Trạm kế tiêp là hạnh phúc', '98830', 31, NOW(), NOW()),
(1, 1, 'Tam sinh tam thế thập lý đào hoa', '69316', 32, NOW(), NOW()),
(1, 1, 'Ngự giao ký', '136973', 33, NOW(), NOW()),
(1, 1, 'Vường sao băng', '16420', 34, NOW(), NOW()),
(1, 1, 'Gửi thời thanh xuân ngây thơ tươi đẹp', '75387', 35, NOW(), NOW()),
(1, 1, 'Ngọc cốt dao', '130270', 36, NOW(), NOW()),
(1, 1, 'Câu chuyện cảm động nhất', '87299', 37, NOW(), NOW()),
(1, 1, 'Cẩm tú vị  ương', '68358', 38, NOW(), NOW()),
(1, 1, 'Thiên quan tứ phúc', '112398', 39, NOW(), NOW()),
(1, 1, 'Vào giờ phút này', '218177', 40, NOW(), NOW()),
(1, 1, 'Công chúa hội tam hoàng', '96049', 41, NOW(), NOW()),
(1, 1, 'Thầm yêu quất sinh hoài nam', '104982', 42, NOW(), NOW()),
(1, 1, 'Sexy central', '91491', 43, NOW(), NOW()),
(1, 1, 'Mẹ đừng làm vậy', '135726', 44, NOW(), NOW()),
(1, 1, 'Cực phẩm xứng đôi', '70580', 45, NOW(), NOW()),
(1, 1, 'Chỉ cần em hạnh phúc', '124578', 46, NOW(), NOW()),
(1, 1, 'Tình yêu đến sau ba ngày', '130839', 47, NOW(), NOW()),
(1, 1, 'Ông chú của tôi', '76662', 48, NOW(), NOW()),
(1, 1, 'Cuộc chiến thượng lưu', '99489', 49, NOW(), NOW()),
(1, 1, 'Sweet home thế giới ma quái', '96648', 50, NOW(), NOW()),
(1, 1, 'Yêu tinh', '67915', 51, NOW(), NOW()),
(1, 1, 'Lời hồi đáp 1988', '64010', 52, NOW(), NOW()),
(1, 1, 'Điên thì có sao', '96462', 53, NOW(), NOW()),
(1, 1, 'Nghệ thuật săn quỷ và nấu mì', '113268', 54, NOW(), NOW()),
(1, 1, 'Chàng trai cuồng sạch sẽ thân yêu của tôi', '125255', 55, NOW(), NOW()),
(1, 1, 'Diên hi công lược', '96997', 56, NOW(), NOW()),
(1, 1, 'Truy bắt lính đào ngũ', '110534', 57, NOW(), NOW()),
(1, 1, 'Luyến mộ', '129478', 58, NOW(), NOW()),
(1, 1, 'Khóa học yêu cấp tốc', '202318', 59, NOW(), NOW()),
(1, 1, 'Tuổi hai lăm tuổi hai mốt', '129888', 60, NOW(), NOW()),
(1, 1, 'Tầng lớp itaewon', '96162', 61, NOW(), NOW()),
(1, 1, 'Trò chơi con mực', '93405', 62, NOW(), NOW()),
(1, 1, 'Hậu duệ mặt trời', '82665', 63, NOW(), NOW()),
(1, 1, 'Lâu đài tham vọng', '84327', 64, NOW(), NOW()),
(1, 1, 'Thế giới hôn nhân', '96164', 65, NOW(), NOW()),
(1, 1, 'Dưới bóng trung điện', '156406', 66, NOW(), NOW()),
(1, 1, 'Quý ngài ánh dương', '75820', 67, NOW(), NOW()),
(1, 1, 'Khu rừng bí mật', '97565', 68, NOW(), NOW()),
(1, 1, 'Người thầy y đức', '68398', 69, NOW(), NOW()),
(1, 1, 'Vì sao đưa anh tới', '60957', 70, NOW(), NOW()),
(1, 1, 'Khi hoa trà nở', '93097', 71, NOW(), NOW()),
(1, 1, 'Quý cô ưu tú', '71497', 72, NOW(), NOW()),
(1, 1, 'Tòa án vị thành niên', '112833', 73, NOW(), NOW()),
(1, 1, 'Con của bạn không phải là con của bạn', '80759', 74, NOW(), NOW()),
(1, 1, 'Mơ hồ', '76715', 75, NOW(), NOW()),
(1, 1, 'Mặt trăng ôm mặt trời', '45579', 76, NOW(), NOW()),
(1, 1, 'Bác sĩ nhân ái', '57647', 77, NOW(), NOW()),
(1, 1, 'Thanh tra Koo', '129475', 78, NOW(), NOW()),
(1, 1, 'Tội nhân vô định', '94384', 79, NOW(), NOW()),
(1, 1, 'Thánh ma túy', '97970', 80, NOW(), NOW()),
(1, 1, 'Sát nhân bắt chước', '158876', 81, NOW(), NOW()),
(1, 1, 'Hoa của quỷ', '99494', 82, NOW(), NOW()),
(1, 1, 'Đội bóng chày Dreams', '95484', 83, NOW(), NOW()),
(1, 1, 'Hướng tới thiên đường', '96571', 84, NOW(), NOW()),
(1, 1, 'Hoa đăng sơ thượng', '130330', 85, NOW(), NOW()),
(1, 1, 'Gió đông năm ấy', '47091', 86, NOW(), NOW()),
(1, 1, 'Đôi mắt rực rỡ', '86546', 87, NOW(), NOW()),
(1, 1, 'Mashle', '204832', 88, NOW(), NOW()),
(1, 1, 'Pháp sư tiễn táng', '209867', 89, NOW(), NOW()),
(1, 1, 'Hậu cung chân hoàn chuyện', '50878', 90, NOW(), NOW()),
(1, 1, 'Chệch quỹ đạo', '237918', 91, NOW(), NOW()),
(1, 1, 'One piece', '111110', 92, NOW(), NOW()),
(1, 1, 'The kings avatar', '71194', 93, NOW(), NOW()),
(1, 1, 'Sơn hà lệnh', '119362', 94, NOW(), NOW()),
(1, 1, 'Tỉnh mộng', '73021', 95, NOW(), NOW()),
(1, 1, 'Thơ săn quái vật', '71912', 96, NOW(), NOW()),
(1, 1, 'Sweet tooth cậu bé gạc nai', '103768', 97, NOW(), NOW()),
(1, 1, 'Arcane', '94605', 98, NOW(), NOW()),
(1, 1, 'Huyển thoại vikings: Valhalla', '116135', 99, NOW(), NOW()),
(1, 1, 'Shadow and bone', '85720', 100, NOW(), NOW()),
(1, 1, 'Biệt đội titans', '75450', 101, NOW(), NOW());
